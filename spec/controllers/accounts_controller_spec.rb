...
context 'A successfully authenticated login' do
  ...
  specify 'cookies[:typoapp_is_admin] should == "yes"' do
    cookies['typoapp_is_admin'].should == ['yes']
  end
...
context 'Login gets the wrong password' do
  ...
  specify 'cookies[:typoapp_is_admin] should be blank' do
    response.cookies[:typoapp_is_admin].should_be_blank
  end
...
context 'User is logged in' do
  ...
  setup do
    ...
    session[:user] = @user
    @user.stub!(:reload).and_return(@user)
    request.cookies[:typoapp_is_admin] = 'yes'
  end
  ...
  specify 'logging out deletes the "typoapp_is_admin" cookie' do
    get 'logout'
    response.cookies[:typoapp_is_admin].should_be_blank
  end
end
